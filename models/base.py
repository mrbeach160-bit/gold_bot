...
def create_model(model_type: str, symbol: str, timeframe: str) -> BaseModel:
    ...
    Args:
        model_type: Type of model ('lstm', 'lightgbm', 'xgboost', 'randomforest', 'svm')
    ...
    from .ml_models import (LSTMModel, LightGBMModel, XGBoostModel, RandomForestModel, SVMModel,
                           TENSORFLOW_AVAILABLE, LIGHTGBM_AVAILABLE, XGBOOST_AVAILABLE, HAS_SKLEARN_EXTRA)
    ...
    model_mapping = {
        ...
        'randomforest': (RandomForestModel, HAS_SKLEARN_EXTRA, "sklearn"),
        'rf': (RandomForestModel, HAS_SKLEARN_EXTRA, "sklearn"),  # Alias
        'svm': (SVMModel, HAS_SKLEARN_EXTRA, "sklearn"),
        'svc': (SVMModel, HAS_SKLEARN_EXTRA, "sklearn"),  # Alias
    }
